...
bool GeneralizeOps_stub(const OpBuildTaskPtr &opTask, GeneralizedResult &generalizedResult)
{
    ...
    std::string currentFilePath = GetCodeDir() + "/tests/engines/nn_engine/st/testcase/op_compile_adapter/stub/binary_stub/fill_opParams.json";
    if (te::fusion::RealPath(currentFilePath).empty()) {
...
bool GeneralizeFusionOps_stub(const OpBuildTaskPtr &opTask, GeneralizedResult &generalizedResult)
{
    ...
    std::string currentFilePath = GetCodeDir() + "/tests/engines/nn_engine/st/testcase/op_compile_adapter/stub/binary_stub/fill_fusionOpParams.json";
    if (te::fusion::RealPath(currentFilePath).empty()) {
        currentFilePath = "../../../../../../../../../llt/atc/opcompiler/te_fusion/st/stub/binary_stub/fill_fusionOpParams.json";
    }
...
TEST(TeFusionBinarySTest, fuzzycompile_binary_fileinvalid_fail) {
    ...
    std::string currentFilePath1 = GetCodeDir() + "/tests/engines/nn_engine/st/testcase/op_compile_adapter/stub/binary_stub/fill.json";
...
TEST(TeFusionBinarySTest, BinaryGeneralizeWithRegisterFuncFusionOp_01) {
    ...
    bool res = te::fusion::ShapeGeneralization::BinaryGeneralizeWithRegisterFuncFusionOp(generalizedRes,
                                                                                           binaryInfo, idx, tbeOpInfo);
    EXPECT_EQ(res, true);
    ...
    GeneralizedResult generalizedResult;
    res = te::fusion::ShapeGeneralization::GenerateNormalizeFusionAttrTmpJson(tbeOpInfoBNU,
                                                         generalizedResult,
                                                         true,
                                                         generalizedRes);
    EXPECT_EQ(res, true);
...
TEST(TeFusionBinarySTest, test_MatchStaticKeyWithOptionalInputNull) {
    ...
    std::string currentFilePath1 = GetCodeDir() + "/tests/engines/nn_engine/st/testcase/op_compile_adapter/stub/binary_stub/conv2d_transpose_op.json";
    ...
    std::string currentFilePath = GetCodeDir() + "/tests/engines/nn_engine/st/testcase/op_compile_adapter/stub/binary_stub/conv2d_transpose.json";
    std::string path = te::fusion::RealPath(currentFilePath);
    ...
    std::string currentFilePath2 = GetCodeDir() + "/tests/engines/nn_engine/st/testcase/op_compile_adapter/stub/binary_stub/conv2d_transpose_fail.json";
...
bool GetBinaryInfoConfigPath_Stub(te::fusion::BinaryInfoBase *This,
                                  const string &configPath, std::string &configRealPath, bool isSuperKernel)
{
    printf("GetBinaryInfoConfigPath_Stub \r\n");

    std::string currentFilePath = GetCodeDir() + "/tests/engines/nn_engine/st/testcase/op_compile_adapter/stub/binary_stub/binary_info_config.json";
    if (te::fusion::RealPath(currentFilePath).empty()) {
        printf("GetBinaryInfoConfigPath_Stub is empty");
        currentFilePath = "../../../../../../../../../llt/atc/opcompiler/te_fusion/st/stub/binary_stub/binary_info_config.json";
    }
...
TEST(TeFusionBinarySTest, test_generate_simple_key_list_001) {
    ...
    nlohmann::json binaryListJson;
    std::string currentFilePath = GetCodeDir() + "/tests/engines/nn_engine/st/testcase/op_compile_adapter/stub/binary_stub/binary_list.json";
    if (te::fusion::RealPath(currentFilePath).empty()) {
...
TEST(TeFusionBinarySTest, test_generate_simple_key_list_002) {
    std::string opType = "Abs";
    nlohmann::json binaryListJson;
    std::string currentFilePath = GetCodeDir() + "/tests/engines/nn_engine/st/testcase/op_compile_adapter/stub/binary_stub/binary_list_no_key.json";
    if (te::fusion::RealPath(currentFilePath).empty()) {
        currentFilePath =
...
TEST(TeFusionBinarySTest, test_generate_simple_key_list_003) {
    std::string opType = "Abs";
    nlohmann::json binaryListJson;
    std::string currentFilePath = GetCodeDir() + "/tests/engines/nn_engine/st/testcase/op_compile_adapter/stub/binary_stub/binary_list_key_not_array.json";
    if (te::fusion::RealPath(currentFilePath).empty()) {
        currentFilePath =
...
TEST(TeFusionBinarySTest, test_generate_simple_key_list_004) {
    std::string opType = "Abs";
    nlohmann::json binaryListJson;
    std::string currentFilePath = GetCodeDir() + "/tests/engines/nn_engine/st/testcase/op_compile_adapter/stub/binary_stub/binary_list_path_null.json";
    if (te::fusion::RealPath(currentFilePath).empty()) {
        currentFilePath =

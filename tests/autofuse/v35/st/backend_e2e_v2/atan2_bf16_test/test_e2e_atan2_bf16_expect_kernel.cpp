...
extern "C" __global__ __aicore__ void atan2_bf16_test(GM_ADDR x1, GM_ADDR x2, GM_ADDR y, GM_ADDR workspace, GM_ADDR tiling);
...
TEST_P(E2E_BackendAtan2Bf16_Code, CalculateCorrect) {
  ...
  ICPU_RUN_KF(atan2_bf16_test, tiling_data.block_dim, (uint8_t *)input1, (uint8_t *)input2, (uint8_t *)y, nullptr, (uint8_t*)&tiling_data);

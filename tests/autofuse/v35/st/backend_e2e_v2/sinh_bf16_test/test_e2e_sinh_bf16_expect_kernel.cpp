...
extern "C" __global__ __aicore__ void sinh_bf16_test(GM_ADDR x0, GM_ADDR output, GM_ADDR workspace, GM_ADDR gm_tiling_data);
...
TEST_P(E2E_SinhBf16_Code, CalculateCorrect){
 ...
 for (int i = 0; i < test_size; i++) {
   x[i] = static_cast<bfloat16_t>(static_cast<bfloat16_t>(i) / test_size * 10.0f - 5.0f);  // Normalize to [-5, 5] range for sinh
...
INSTANTIATE_TEST_SUITE_P(CalcWithDifferentShape, E2E_SinhBf16_Code,
